...
//           <span class="qty-pill">${i.quantity}×</span>
//           <span class="plan-item-name">${escapeHtmlMealPlan(i.name)}</span>
//           <span class="plan-item-price">₹${i.lineTotal}</span>
//         </div>
//       `
//             )
//             .join("");

//         const pct = Math.min(100, Math.round((plan.estimatedTotal / plan.budget) * 100));
//         const overBudget = !plan.withinBudget;

//         resultEl.innerHTML = `
//       <div class="plan-card mb-3">
//         <div class="plan-items mb-1">${rows}</div>
//         <div class="budget-bar-track">
//           <div class="budget-bar-fill" style="width:${pct}%; background: ${overBudget ? "var(--chili)" : "var(--cardamom)"};"></div>
//         </div>
//         <div class="budget-bar-labels">
//           <span class="${overBudget ? "over" : ""}">₹${plan.estimatedTotal} estimated${overBudget ? " · over budget" : ""}</span>
//           <span>₹${plan.budget} budget</span>
//         </div>
//       </div>
//       <p class="text-xs mb-3" style="color: var(--charcoal-soft)">For ${plan.peopleCount} people, ${dietPreference.value} · ${mealType.value}</p>
//       <button id="add-plan-to-cart-btn" class="btn-primary w-full py-2.5 text-sm">Add all to cart</button>
//     `;
