...
const sessionItemSchema = new mongoose.Schema(
  {
    ...
    price: { type: Number, required: true, min: 0 }, // snapshot, re-verified at confirm time
    quantity: { type: Number, required: true, min: 1 },
    addedByDeviceId: { type: String, required: true },
    addedByName: { type: String, default: "Guest" },
  },
  { timestamps: true }
);
